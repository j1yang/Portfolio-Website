      ...
      <div className='text-center'>
        ...
        <div className='mx-auto object-center'>
          ...
          <div className='w-[200px] h-7 flex justify-between mb-4 text-xl mx-auto'>
              ...
              <h3 className='my-auto'>Toronto, Canada</h3>
          </div>
          ...
          <div className='w-[140px] flex justify-between mx-auto'>
            ...
            <SocialIcon style={{ height: 40, width: 40}} className='hover:scale-110 ease-in-out transition duration-500' url="mailto:jay.jaewon.yang@gmail.com"/>
          </div>
        </div>
      </div>
